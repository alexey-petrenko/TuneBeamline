...
from plot_aperture_old import plot_aperture
...
if __name__ == '__main__':
    ...
    # data_exchange = DataExchange('/home/vbalakin/PycharmProjects/accel_packages/TuneBeamline/cx_data_config.json',
    #                                'bpm', 'cor')
